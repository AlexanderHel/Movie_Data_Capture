...
class Xcity(Parser):
    ...
    expr_runtime = '//span[@class="koumoku" and text()="Running Time"]/../text()'
    ...
    expr_tags = '//span[@class="koumoku" and text()="Genres"]/../a[starts-with(@href,"/avod/genre/")]/text()'
    expr_cover = '//*[@id="avodDetails"]/div/div[3]/div[1]/p/a/@href'
    expr_director = '//*[@id="program_detail_director"]/text()'
    expr_series = "//span[contains(text(),'Series')]/../a/span/text()"
    expr_series2 = "//span[contains(text(),'Series')]/../span/text()"
    ...
    def queryNumberUrl(self, number):
        ...
        query_result, browser = get_html_by_form(
            'https://xxx.xcity.jp/' + secrets.choice(['sitemap/','policy/','law/','help/','main/']),
        ...
        return urljoin('https://xxx.xcity.jp', prelink)
